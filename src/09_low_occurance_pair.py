...
#To find low occurace pair
Pairs=co_matrix_no_diagonal.unstack()
low_pairs=Pairs.sort_values().dropna().head(10)
low_pairs=low_pairs[low_pairs.index.get_level_values(0)<low_pairs.index.get_level_values(1)]
# Save results
low_pairs.to_csv("results/table/low_pairs.csv")
